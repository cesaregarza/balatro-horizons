      ...
      {call.tools.map((tool, ordinal) => {
        ...
        return (
          <section
            ...
            aria-label={`Requested tool ${ordinal + 1}`}
          >
            ...
            {tool.arguments_parse_error ? (
              <p className="dev-error">
                Arguments are not valid JSON; this request cannot be
                interpreted. Original text is in technical details.
              </p>
            ) : (
              <>
                ...
                {(args.note_update != null || args.memory_update != null) && (
                  <div className="dev-model-note">
                    ...
                    <ReadableValue
                      value={args.note_update ?? args.memory_update}
                    />
                  </div>
                )}
              </>
            ...
            {tool.delivered_results.map((result, i) => (
              <div className="dev-result" key={i}>
      ...
      <details className="dev-technical">
        ...
        {call.tools.map((tool, i) => (
          <div key={i}>
            ...
            {tool.delivered_results.map((result, j) => (
              <JsonPanel
                key={j}
