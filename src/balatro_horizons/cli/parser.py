...
def add_evidence_commands(sub):
    ...
    plan.add_argument("--connection-only", action="store_true")
    plan.add_argument("--continuation-only", action="store_true")
    plan.add_argument("--interruption-only", action="store_true")
    plan.add_argument("--session-expiry-only", action="store_true")
    ...
    collect.add_argument("--continuation-only", action="store_true", help="Unpaid initial-blind fixture and three probes; no backend required")
    collect.add_argument("--interruption-only", action="store_true", help="Bounded native fault classification; no certificate writes")
    collect.add_argument("--session-expiry-only", action="store_true", help="One replay then disposable WSL session expiry; no certificate writes")
    collect.add_argument("--fixture-report", type=Path, help="Passed interruption receipt supplying an unchanged excluded fixture")
    collect.add_argument("--report", type=Path, help="New Linux receipt path for continuation or interruption collection")
