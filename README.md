...
are local artifacts, not source-controlled inputs. See [third-party notices]
(docs/THIRD_PARTY.md) and the [original contract]
(docs/contract/balatro_horizons_spec/BALATRO_HORIZONS_SPEC.md).
